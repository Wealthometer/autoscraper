...
```bash
$ pip install git+https://github.com/Wealthometer/autoscraper.gitt
...
url = 'https://github.com/Wealthometer/autoscraper'

wanted_list = ['A Smart, Automatic, Fast and Lightweight Web Scraper for Python', '6.2k', 'https://github.com/Wealthometer/autoscraper/issues']
